  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        >
          <li>
            <img :src="good.imgUrl" style="width: 82px; height: 82px" />
          </li>
          <li>
            <p>{{ good.skuName }}</p>
            <h4>7天无理由退货</h4>
...
export default {
  ...
  mounted() {
    this.$store.dispatch("tradeOptions/getUserAddress");
    this.$store.dispatch("tradeOptions/getOrderInfo");
  },
  computed: {
    ...mapState("tradeOptions", ["address", "orderInfo"]),
