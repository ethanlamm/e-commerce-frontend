      ...
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            ...
            <li
              class="with-x"
              v-for="(attrName, index) in searchParams.props"
              :key="index"
            >
              {{ attrName.split(":")[1] }}<i @click="removeAttr(index)">×</i>
            </li>
          </ul>
        </div>
        ...
        <div class="details clearfix">
          ...
          <div class="sui-navbar">
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{ active: composite }" @click="changeOrder('1')">
                  <a
                    >综合
                    <span
                      v-show="composite"
                      class="iconfont"
                      :class="{
                        'icon-jiantou_xiangxia': desc,
                        'icon-jiantou_xiangshang': asc,
                      }"
                    ></span
                  ></a>
                </li>
...
export default {
  ...
  methods: {
    ...
    getData() {
      this.$store.dispatch("searchOptions/getSearchInfo", this.searchParams);
    },
